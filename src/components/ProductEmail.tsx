        ...
        <Tailwind>
          <Body className="bg-white font-sans">
            <Container style={container}>
              <Text className="text-2xl font-semibold">Dear Customer,</Text>
              <Text className="text-lg text-gray-600">
                Thank you for buying your product at DigiMart. Below is your download link.
              </Text>
              ...
              <Text className="text-lg">
                 Thankyou for shopping <br/>DigiMart Team
              </Text>
            </Container>
          </Body>
        </Tailwind>
